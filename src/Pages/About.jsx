...
function About() {
    ...
    return (
        <>
            <div className={`w-full h-screen bg-[#F5F5F7] ${dark ? 'bg-[#121212]' : 'bg-[#F5F5F7]'} `}>

                <div className={`flex justify-center flex-col w-full bg-[#F5F5F7] ${dark ? 'bg-[#121212]' : 'bg-[#F5F5F7]'}`}>
                    ...
                    <div className='flex flex-row items-center justify-center w-10/12 mx-auto'>
                        <div className={`${dark ? 'bg-[#1E1E1E] text-[#F5F5F7]' : 'bg-[#F5F5F7]'} flex flex-col bg-[#FFFFFF] items-center w-[250px] h-[300px] m-8 rounded-xl shadow-2xl transition-transform duration-300 hover:scale-105`}> {/* Added transition and hover effect */}
                            <div>
